...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-dacar-detailing-market-pos-system-secret-key-2026')
...
# Database: Uses PostgreSQL on Render / Cloud if DATABASE_URL is set, otherwise SQLite
DATABASES = {
