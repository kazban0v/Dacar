...
# Note: POS terminal is desktop-only (cashier works on PC), not included here.
urlpatterns = [
    path('orders/', views.sales_orders_list_view, name='m_sales_orders_list'),
    path('orders/<int:pk>/print/', views.order_detail_print_view, name='m_order_print'),
